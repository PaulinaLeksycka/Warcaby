...
public class Warcaby {
	...
	boolean MozliwyRuch(int Z, int Do) {
		...
		if (x1>=0 && x2>=0 && y1<=7 && y2<=7 && x1<=7 && x2<=7 && y1>=0 && y2>=0 ) {
			...
			if (Math.abs(x1-x2)==1&& Math.abs(y1-y2)==1 &&  (pionek=='C' || pionek=='B')){
				if (plansza[x2][y2]==' ') {
					return true;
				}
			}
			
			if ((Math.abs(x1-x2)==2 && y1-y2==-2 &&pionek=='b')){
				if (plansza[(x1+x2)/2][(y1+y2)/2]=='c'||plansza[(x1+x2)/2][(y1+y2)/2]=='C') {
					czarne_pionki--;
					return true;
				}
			}
			if ((Math.abs(x1-x2)==2 && y1-y2==2 && pionek=='c')){
				if (plansza[(x1+x2)/2][(y1+y2)/2]=='b' || plansza[(x1+x2)/2][(y1+y2)/2]=='B') {
					biale_pionki--;
					return true;
				}
			}
	...
	boolean Istnieje_bicie(int x2, int y2) {
		...
		if (pionek=='b' || pionek=='B') {
			if (x2>1 && y2>1 && x2<6 && y2<6) {
				...
				if((plansza[x2][y2]=='B') && (plansza[x2-1][y2-1]=='c' ||plansza[x2-1][y2-1]=='C') && plansza[x2-2][y2-2]==' ') {
			    	return true;
			    }
			    if((plansza[x2][y2]=='b' || plansza[x2][y2]=='B') && (plansza[x2-1][y2+1]=='c'|| plansza[x2-1][y2+1]=='C') && plansza[x2-2][y2+2]==' ') {
			    	return true;
			    }
			    if((plansza[x2][y2]=='B')  && (plansza[x2+1][y2-1]=='c' || plansza[x2+1][y2-1]=='C')&& plansza[x2+2][y2-2]==' ') {
			    	return true;
		...
		if (pionek=='c' || pionek=='C') {
			if (x2>1 && y2>1 && x2<6 && y2<6) {
				if((plansza[x2][y2]=='c'||plansza[x2][y2]=='C') && (plansza[x2-1][y2-1]=='b'||plansza[x2-1][y2-1]=='B') && plansza[x2-2][y2-2]==' ') {
					return true;						
				}
				if((plansza[x2][y2]=='C') && (plansza[x2-1][y2+1]=='b'||plansza[x2-1][y2+1]=='B') && plansza[x2-2][y2+2]==' ') {
					return true;
				}
			    if((plansza[x2][y2]=='c'||plansza[x2][y2]=='C') && (plansza[x2+1][y2-1]=='b'||plansza[x2+1][y2-1]=='B') && plansza[x2+2][y2-2]==' ') {
			    	return true;
